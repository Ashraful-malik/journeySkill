...
export default function AnalyticsPage({ challengeAnalyticsData }) {
  ...
  // check onboarding is completed or not
  useEffect(() => {
    const checkOnboarding = async () => {
      const response = await getOnboarding(userId, "analyticsPage");
      if (response?.data) {
  ...
  return (
    <>
      {runTour !== null && (
        <ChallengeAnalyticsTour run={runTour} setRun={setRunTour} />
      )}
      <div className="container mx-auto px-4 py-8 lg:px-0">
        <header className="mb-8" data-tour="heading">
        ...
        <Dialog>
          <DialogTrigger asChild data-tour="challenge-completion">
          ...
          <DialogContent>
            ...
            <ul>
              <li>
                <strong>Complete the tasks:</strong> You only need to do one
                task each day. No need to overdo it — even if you post multiple
                times, only one counts for that day.
              </li>
              <li>
                <strong>Stay consistent:</strong> Post for at least{" "}
                <strong>{challengeData.consistencyIncentiveDays}</strong> days
                in a row. Skip a day? No problem! Just keep the streak unbroken.
              </li>
            </ul>
            <p>
        ...
        <section className="mb-8" data-tour="overview">
        ...
        <section className="mb-8" data-tour="task-chart">
        ...
        <section className="mb-8" data-tour="heatmap">
        ...
        <section className="mb-8" data-tour="challenge-details">
              ...
              <div className="mb-4">
                ...
                challengeData.currentStreak >=
                  ...
                  <p className="text-red-500">
                    💪 Keep going! Focus on completing tasks and maintaining
                    your streak.
                  </p>
                )}
              </div>
